...
from third_party.SAI3D.SemanticSAM.utils.arguments import load_opt_from_config_file
from third_party.SAI3D.SemanticSAM.semantic_sam.BaseModel import BaseModel
from third_party.SAI3D.SemanticSAM.semantic_sam import build_model
from third_party.SAI3D.SemanticSAM.tasks.automatic_mask_generator import SemanticSamAutomaticMaskGenerator
from third_party.SAI3D.SemanticSAM.tasks.interactive_idino_m2m_auto import show_anns
from third_party.SAI3D.SemanticSAM.tasks.interactive_predictor import SemanticSAMPredictor
...
def build_semantic_sam(model_type, ckpt):
    ...
    build model
    """
    cfgs={'T':"third_party/SAI3D/SemanticSAM/configs/semantic_sam_only_sa-1b_swinT.yaml",
          'L':"third_party/SAI3D/SemanticSAM/configs/semantic_sam_only_sa-1b_swinL.yaml"}
