...
from third_party.SAI3D.helpers.sam_utils import get_sam_by_iou, get_sam_by_area, num_to_natural, viz_mask, my_prepare_image
from third_party.SAI3D.SemanticSAM.semantic_sam import build_semantic_sam, SemanticSamAutomaticMaskGenerator
...
def seg_scannet(base_dir, view_freq, scene_id=None):
    ...
    sam_model = build_semantic_sam(
            model_type='L', ckpt='third_party/SAI3D/SemanticSAM/checkpoints/swinl_only_sam_many2many.pth')
