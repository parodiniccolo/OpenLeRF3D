...
def save_scannet_eval_format_to_mesh(scene_id, 
    ...
    ply_path = join(data_dir, f'replica_{scene_id}', f'{scene_id}_mesh.ply')
    ...
    save_path = join(data_dir, f'replica_{scene_id}', f'{scene_id}_vis.ply')
...
if __name__ == '__main__':
    ...
    parser.add_argument('scene_id', type=str, help='The ID of the scene to process')
    parser.add_argument('res_dir', type=str, help='The directory containing the results')
    parser.add_argument('data_dir', type=str, help='The data directory')

    args = parser.parse_args()

    save_scannet_eval_format_to_mesh(args.scene_id, args.res_dir, args.data_dir)