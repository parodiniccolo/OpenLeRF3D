...
from depthlerf.data.utils.dino_dataloader import DinoDataloader
from depthlerf.data.utils.pyramid_embedding_dataloader import PyramidEmbeddingDataloader
from depthlerf.encoders.image_encoder import BaseImageEncoder
from nerfstudio.data.datamanagers.base_datamanager import VanillaDataManager, VanillaDataManagerConfig
from nerfstudio.data.datasets.depth_dataset import DepthDataset

@dataclass
class DepthLERFDataManagerConfig(VanillaDataManagerConfig):
    _target: Type = field(default_factory=lambda: DepthLERFDataManager)
    patch_tile_size_range: Tuple[int, int] = (0.05, 0.5)
    patch_tile_size_res: int = 7
    patch_stride_scaler: float = 0.5


class DepthLERFDataManager(VanillaDataManager[DepthDataset]):  # pylint: disable=abstract-method
    ...
    config: DepthLERFDataManagerConfig
